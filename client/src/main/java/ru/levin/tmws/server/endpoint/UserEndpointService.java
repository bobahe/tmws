...
public class UserEndpointService extends Service {
    ...
    public final static QName SERVICE = new QName("http://endpoint.server.tmws.levin.ru/", "UserEndpointService");
    public final static QName UserEndpointPort = new QName("http://endpoint.server.tmws.levin.ru/", "UserEndpointPort");
    static {
        URL url = null;
        try {
