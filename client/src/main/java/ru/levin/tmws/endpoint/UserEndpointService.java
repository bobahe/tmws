 ...
 * 2019-07-18T17:36:29.231+03:00
 * Generated source version: 3.2.7
 *
 */
@WebServiceClient(name = "UserEndpointService",
                  wsdlLocation = "http://localhost:80/tm/UserEndpoint?wsdl",
...
public class UserEndpointService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("http://localhost:80/tm/UserEndpoint?wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(UserEndpointService.class.getName())
                .log(java.util.logging.Level.INFO,
                     "Can not initialize the default wsdl from {0}", "http://localhost:80/tm/UserEndpoint?wsdl");
        }
        WSDL_LOCATION = url;
    }
