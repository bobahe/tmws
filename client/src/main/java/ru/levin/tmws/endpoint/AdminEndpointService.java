 ...
 * 2019-07-18T17:36:29.308+03:00
 * Generated source version: 3.2.7
 *
 */
@WebServiceClient(name = "AdminEndpointService",
                  wsdlLocation = "http://localhost:80/tm/AdminEndpoint?wsdl",
...
public class AdminEndpointService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("http://localhost:80/tm/AdminEndpoint?wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(AdminEndpointService.class.getName())
                .log(java.util.logging.Level.INFO,
                     "Can not initialize the default wsdl from {0}", "http://localhost:80/tm/AdminEndpoint?wsdl");
        }
        WSDL_LOCATION = url;
    }
